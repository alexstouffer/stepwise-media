  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center">
      ...
      <main className="flex w-full flex-1 flex-col justify-center">
        <section className="flex text-secondary items-center bg-center bg-cover justify-end bg-no-repeat" style={{ 
          backgroundImage: `url(${'pmbok-insights.png'})`,
          height: '84vh'
        }} >
        ...
        <section className="problem p-10 bg-white flex flex-col lg:flex-row-reverse lg:justify-center">
          <div className="w-full md:w-1/3 flex items-center justify-center p-10 bg-[url('/pmbok-insights.png')] bg-contain bg-center bg-no-repeat rounded-xl">
          </div>
